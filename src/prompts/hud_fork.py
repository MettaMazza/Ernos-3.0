                ...
                if all_lines:
                    ...
                    try:
                        ...
                        if last_ts:
                            ...
                            from src.memory.temporal import _format_duration
                            fhud["time_since_last_message"] = _format_duration(max(0, gap))
                    except Exception as e:
                        logger.warning(f"Time since last message calc failed: {e}")
