...
class LaneQueue:
    ...
    DEFAULT_LANES = {
        "chat": LanePolicy(max_parallel=1, timeout_seconds=120, max_queue_depth=10),
        "autonomy": LanePolicy(max_parallel=1, timeout_seconds=300, max_queue_depth=5),
        "gaming": LanePolicy(max_parallel=1, timeout_seconds=60, max_queue_depth=20),
        "background": LanePolicy(max_parallel=3, timeout_seconds=600, max_queue_depth=15),
    }
