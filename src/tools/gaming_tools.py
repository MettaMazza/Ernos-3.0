...
@ToolRegistry.register(
    name="start_game",
    description=(
        "[ADMIN ONLY] Start a Minecraft gaming session. "
        "Defaults to localhost:25565 — just call start_game(game=\"minecraft\") with NO host/port unless the admin specifies different ones. "
        "Do NOT search memory for server addresses."
    )
)
