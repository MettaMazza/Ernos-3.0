...
class PromptTunerAbility(BaseAbility):
    ...
    TUNER_DIR = Path("memory/system/prompt_tuner")
    PROPOSALS_FILE = Path("memory/system/prompt_tuner/proposals.json")
    HISTORY_FILE = Path("memory/system/prompt_tuner/history.json")
