...
class TestGamingAgentCognition:
    ...
    def setup_method(self):
        ...
        self.mock_bot.tape_engine = AsyncMock()
    ...
    async def test_cognition_returns_tuple_of_two(self):
        ...
        self.mock_bot.cognition.process = AsyncMock(return_value=("ACTION: explore", [], []))
        ...
        # _think returns (actions_list, precognition_list) tuple
    ...
    async def test_cognition_returns_tuple_of_three_regression(self):
        ...
        self.mock_bot.cognition.process = AsyncMock(return_value=("ACTION: scan", [], {"extra": "data"}))
    ...
    async def test_cognition_returns_string_directly(self):
        ...
        self.mock_bot.cognition.process = AsyncMock(return_value="ACTION: wander")
    ...
    async def test_cognition_returns_empty_tuple(self):
        ...
        self.mock_bot.cognition.process = AsyncMock(return_value=())
    ...
    async def test_cognition_returns_none(self):
        ...
        self.mock_bot.cognition.process = AsyncMock(return_value=None)
    ...
    async def test_no_action_in_response_fallback(self):
        ...
        self.mock_bot.cognition.process = AsyncMock(return_value=("I should explore the area", [], []))
