...
def test_search_web_empty(mock_bing, mock_google, mock_yahoo, mocker):
    mock_ddgs_cls = MagicMock()
    mock_instance = MagicMock()
    mock_instance.__enter__.return_value = mock_instance
...
@patch("src.tools.web._fallback_google_search", return_value=[])
@patch("src.tools.web._fallback_bing_search", return_value=[])
def test_search_web_import_error(mock_bing, mock_google, mock_yahoo, mocker):
    # Patch _get_ddgs to return None (simulating missing ddgs import)
...
@patch("src.tools.web._fallback_google_search", return_value=[])
@patch("src.tools.web._fallback_bing_search", return_value=[])
def test_search_web_generic_error(mock_bing, mock_google, mock_yahoo, mocker):
    mock_ddgs_cls = MagicMock()
