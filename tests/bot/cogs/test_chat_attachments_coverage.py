...
class TestDocumentAttachments:
    ...
    async def test_json_backup_detection(self):
        ...
        cog = _cog(bot)
        cog.preprocessor.process = AsyncMock(return_value={"intent": "restore", "complexity": "HIGH"})
...
class TestBackupRestore:
    ...
    async def test_backup_verify_valid(self):
        ...
        cog = _cog(bot)
        cog.preprocessor.process = AsyncMock(return_value={"intent": "query", "complexity": "LOW"})
    ...
    async def test_backup_verify_invalid(self):
        ...
        cog = _cog(bot)
        cog.preprocessor.process = AsyncMock(return_value={"intent": "check", "complexity": "LOW"})
